...
const UpdateSupplier = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Supplier modifié avec succès', response.data);
      ...
      if (error.response?.data?.message) {
        ...
        setErrorMessage(['Une erreur est survenue lors de la modification du fournisseur']);
      }
    } finally {
      setIsLoading(false);
    }
          ...
          <div className="bg-gradient-to-r from-amber-600 to-yellow-600 px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-amber-100 text-sm">Modifier les informations du fournisseur</p>
              </div>
            </div>
          </div>
