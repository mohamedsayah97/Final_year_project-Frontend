...
const UpdateWorker = () => {
  ...
  // ✅ Déclarer fetchWorker AVANT le useEffect
          ...
          <form className="p-6 space-y-5" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-200 outline-none transition"
                  value={firstName}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="number"
                    placeholder="50000"
                    className="w-full pl-8 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-200 outline-none transition"
                    value={salary}
